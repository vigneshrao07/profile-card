...
const Profile = ({ name, title, image, bio, followers, likes, photos, backgroundImage }) => {
  return (
    <div className="max-w-sm mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
      ...
      <div className="mt-4 mb-4 flex justify-center gap-6 text-2xl">
        <a href="https://facebook.com" target="_blank" rel="noreferrer" className="text-blue-600 hover:scale-110 transition">
          <FaFacebookF />
        </a>
        <a href="https://twitter.com" target="_blank" rel="noreferrer" className="text-sky-400 hover:scale-110 transition">
          <FaTwitter />
        </a>
